...
class ProductMapper extends Mapper{
    function __construct(){
        ...
        $this->selectAllStmt = self::$PDO->prepare("SELECT * FROM pro_size order by length,width,think");
    ...
    function getCollection(array $raw){
	    $factory = new DomainObjectFactory("Product");
        return new Collection($raw,$factory,"Product");
    }
