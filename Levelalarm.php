...
class Levelalarm extends DomainObject{
	function __construct($array){
		parent::__construct($array,array("levelid","alarm","type","x0","y0","x1","y1","width","radius","area","sound","flash","vibrate","image","time"));
	}
	...
	function setImage($data_s){
		$this->objects["image"] = (int)$data_s;
	}
