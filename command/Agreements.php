...
<p>2.1 All other rights not expressly authorized in this agreement belong to the developer. If you need to use any other rights not granted in this agreement, you must obtain the written consent of the developer.</p>

<p>2.2 If you use the application services of a third party through the software, you should sign a separate service agreement with the third party.</p>

<p> 2.3 You should license, but not limit, access to third-party apps through the links in the software</p>

<p>2.4 The developer allows you to download, install and run the software on your mobile phone. The license is limited, non transferable, non sublicensable, revocable, non exclusive and non exclusive.</p>

<h4> 3 Software licensing</h4>
<p>You may use the software in accordance with this Agreement on the premise of complying with national laws, regulations, policies and this agreement. You have no right or right to perform the following actions, including but not limited to:</p>

<p>3.1 Delete any copyright notice or prompt and any other information and content in the software.</p>

<p>3.2 Reverse engineer, reverse assemble and reverse compile the software.</p>

<p>3.3 Use, copy, modify, lease or transfer the software or any part of the software beyond the terms of this agreement.</p>

<p>3.4 Provide the software to a third party, license others to use the software or use the software for the purpose of licensing others to use the software or use the software for the purpose prohibited by developers (such as commercial purpose, etc.).</p>

<p>3.5 Unauthorized implementation of image, text and other related information of the software includes but is not limited to the following acts: use, copy, modify, link, reprint, assemble, publish, publish, establish image site, develop derivative products, works and services related to the software with the help of the software.</p>

<p>3.6 Use this software to store, publish and disseminate content in violation of national laws, regulations and policies.</p>

<p>3.7 Use this software to store, publish and disseminate the content infringing other's intellectual property rights, trade secrets and other legitimate rights.</p>

<p>3.8 Conduct behaviors endangering computer network security.</p>

<h4>4 Suspension and termination of services</h4>
<p>4.1 If you publish illegal information, seriously violate social morality and other laws, the developer has the right to terminate the service immediately.</p>

<p> 4.2 If you violate Article 5 of this Agreement and other developer service terms, end-user license agreement and privacy policy when accepting party A's services, the developer has the right to terminate the services provided to you.</p>

<p>4.3 If you provide false registered identity information or violate this agreement, the developer has the right to suspend all or part of the services provided to you within a reasonable period; the developer will notify you and inform you of the suspension period when taking the suspension measures, and the developer will resume the services to you in a timely manner after the expiration of the suspension period.</p>

<p>4.4 If the developer suspends or terminates providing part or all of the services to you in accordance with this article, it will bear the corresponding burden of proof.</p>

<h4> 5 Technical support</h4>
<p>Under this agreement, the developer does not provide any technical support services for the software.</p>

<h4>6 Version upgrade</h4>
<p> It is up to the developer to decide whether to provide an upgraded version of the software in the future. If the software is upgraded with the consent of the developer, unless there is an alternative software license agreement for the upgraded version, the upgraded version still applies to this agreement. If the software is marked as upgraded, you must comply with this agreement.</p>

<h4>7 Legal liability</h4>
<p>7.1 You agree to use the software at your own risk.</p>

<p>7.2 You agree that the software may be disturbed by various security issues, such as other people's use of your data, causing real-life harassment. The downloaded and installed software contains Trojan horse and other viruses, which threaten the security of your information and data, and then affect the normal use of the software and so on. You should strengthen the awareness of information security and protection of information resources, and pay attention to password protection to avoid loss and harassment.</p>

<p> 7.3 This software is licensed "as is.". The developer does not provide any express or implied warranties and guarantees on the software, including no express or implied warranties on the marketability and specific use of the software, and the developer does not make any warranties on the non infringement of the rights of third parties.</p>

<p>7.4 To the maximum extent permitted by applicable law, the developer shall not be liable for any direct, indirect, accidental, special, punitive or other damages (including but not limited to those caused by personal injury or property damage) caused by or related to the use or inability to use the software;</p>

<p>7.5 Any other software derived from the software without the authorization of the developer is illegal. Downloading, installing and using such software may lead to unpredictable risks. It is recommended that you do not download, install and use such software easily. All losses, damages, legal liabilities and disputes arising therefrom shall be borne by you and have nothing to do with developers.</p>

<p>7.6 You shall be fully responsible for all liabilities caused by your violation of the law or breach of this agreement. If the developer suffers losses, the developer has the right to claim full compensation from you.</p>

<h4>8 Lapse of a right</h4>
<p>Developer shall have the right to terminate or terminate this agreement at any time. After the termination of this agreement, you must immediately stop using the software and delete all software and related materials that have been copied and installed.</p>

<h4>9 Network security and privacy protection</h4>
<p>Based on the basic principle of protecting user's personal information, developers will take reasonable measures to protect your personal information. Unless otherwise stipulated by laws and regulations, developers will not disclose users' personal information to third parties without your permission. Developers use professional encryption storage and transmission mode for relevant information to ensure the safety of users' personal information. You need to provide some necessary information in the process of registering account or using this service. For example, in order to provide you with account registration service or user identification, you need to fill in your mobile phone number or email address; the function of nearby people requires you to agree to use your geographic location information; the function of recommending contact friends to me and adding friends from contacts needs your authorization Access to mobile phone address book, etc. Developer account users can search for you by mobile phone number or email address, and view your avatar, nickname and region information. You can also turn off the corresponding search switch in the settings of the developer account to avoid being found by new friends. If the national laws and regulations or policies have special provisions, you need to provide real identity information. If you do not provide the information in full, you cannot use it. Your initial registration information can not be modified due to the security of your initial registration, but you can't provide any other information for verification and modification at any time. Developers will use a variety of security technologies and procedures to establish a sound management system to protect</p>

<p>9.1 You or your guardian authorized the developer to disclose;</p>

<p>9.2 The developer is required by relevant laws to disclose;</p>

<p>9.3 Provided by the developer as required by the judicial or administrative authorities based on legal procedures;</p>

<p>9.4 When the developer brings a lawsuit or arbitration to Party B in order to protect his legal rights and interests;</p>

<p>9.5 When providing your personal identity information at the legal request of your guardian.</p>

<h4>10 Other clauses</h4>
<p>10.1 The invalidity of any provision of this agreement in part or in whole shall not affect the validity of other provisions.</p>

<p>10.2 The interpretation, validity and dispute settlement of this Agreement shall be governed by the laws of the people's Republic of China. Any dispute or dispute arising from this Agreement shall be settled through friendly negotiation. If negotiation fails, you hereby fully agree to submit the dispute or dispute to Lianyungang Arbitration Commission for arbitration. The arbitration award is final and binding on both parties. All costs of arbitration shall be borne by the losing party.</p>

<p>10.3 For questions about the software, you can call the customer service hotline.</p>
...
<p>1 Equipment information: such as mobile phone operating system, mobile phone language, terminal model, mobile phone networking mode, mobile phone SIM card, etc.</p>

<p>2 Client information: such as client version number, client download channel, time of user opening / closing client, time and location of user opening third-party app, etc.</p>

<p>3 Application information: such as application error information, whether the service is started, etc.</p>

<p>If you do not want your above information to be collected and analyzed by developers, please do not continue and exit this program.</p>

<p> In addition, the software needs to access the network in the process of use, the generated traffic fee is charged by the operator, please consult your operator for details.</p>

<p> If you have any questions, you can contact the developer for more information.</p>

<p> All rights reserved. The developer reserves the right of interpretation within the scope permitted by law.</p>
...
<h4>1 知识产权声明</h4>
<p>本软件由开发者许可。本软件的知识产权以及与本软件相关的所有信息内容，包括但不限于：文字表述及其组合、图标、图饰、图表、色彩、界面设计、版面框架、有关数据、印刷材料、电子文档等，均受著作权法和国际著作权条约以及其他知识产权法律、法规的保护，其知识产权均归开发者所有。</p>
...
<p>9.5 应您的监护人的合法要求而提供您的个人身份信息时。</p>
...
<p>In order to get a better experience and provide statistical analysis and message push services, when using our services, I may ask you to provide us with some personal identity information, including but not limited to mobile contact, location information, application opening time, mobile ID and unique device ID (Android id/idfa/openudid/guid).
...
<p>This application uses Google's AdMob SDK (see http://www.google.com/ads/admob/ ）For advertising push. The AdMob SDK may have the right to collect and use unique device IDs (Android id/idfa/openudid/guid) to display advertisements according to your preferences. By using this application, you agree to <a href=“ https://policies.google.com/privacy " target="_ Blank "> AdMob privacy policy </a ></P>
...
<p>IOS system /android system permission call description</P>
<ul><li>Sensor: provides the data source of the level. Open the app to approve the privacy policy and ask whether it is authorized.</li>
<li>Storage: used to store user records and recorded data, user preferences, etc. Open the app to approve the privacy policy and ask whether it is authorized.</li>
<li>Camera: used for flash alarm. The user asks whether to authorize after turning on the flash alarm.</li>
</ul>
...
<!--<p>为了获得更好的体验，在使用我们的服务时，我可能会要求您向我们提供某些个人身份信息，包括但不限于移动联系人、位置信息、应用程序打开时间、移动ID、唯一设备识别码（android ID/IDFA/OPENUDID/GUID）以提供统计分析和消息推送服务。我请求的信息将保留在您的设备上，我不会以任何方式收集这些信息。</p>-->

<p>为了获得更好的体验,  以及提供统计分析和消息推送服务，在使用我们的服务时，我可能会要求您向我们提供某些个人身份信息，包括但不限于移动联系人、位置信息、应用程序打开时间、移动ID、唯一设备识别码（android ID/IDFA/OPENUDID/GUID）。</p>
...
<p>该应用程序使用了 Google 公司的 AdMob  SDK（请参阅http://www.google.com/ads/admob/），用于广告推送。AdMob  SDK 可能有权收集和使用唯一设备识别码（android ID/IDFA/OPENUDID/GUID），以根据您的偏好展示广告。使用该应用程序，即表示您同意 <a href="https://policies.google.com/privacy" target="_blank">AdMob 隐权政策</a > 。</p>
...
<p>iOS 系统/Android系统权限调用说明</p>
<ul><li>传感器: 提供水平仪的数据源。打开APP同意隐私政策后询问是否授权。</li>
<li>存储: 用于存储用户记录和录制的数据，用户偏好设置等。打开APP同意隐私政策后询问是否授权。</li>
<li>相机: 用于闪光灯报警。用户打开闪光灯报警后询问是否授权。</li>
</ul>
...
// seene measure
public static $measure_privacy_en=<<<PEN
<div class="content" role="main">    <h3>Privacy Policy</h3>

<p>This clause is only applicable to Liu Xingming's Seene Measure app software products or services.</p>

<p>I built the Seene Measure app as a Free app. This SERVICE is provided by me at no cost and is intended for use as is.</p>

<p>This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.</p>

<p>If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.</p>

<p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Seene Measure unless otherwise defined in this Privacy Policy.</p>
...
<p>I value your trust in providing us your Personal Information, thus we are striving to use commercially acceptable means of protecting it. But remember that no method of transmission over the internet, or method of electronic storage is 100% secure and reliable, and I cannot guarantee its absolute security.</p>
<p>IOS system /android system permission call description</P>
<ul><li>Storage: used to store user records, measurement file data, user preferences, etc. Open the APP and ask whether to authorize after agreeing to the privacy policy</ li>
<li>Camera: used to take photos of measuring targets and reference targets. Ask if you are authorized before using the camera for the first time</ li>
</ul>
...
public static $measure_privacy_cn=<<<PCN
<div class="content" role="main">    <h3>隐私条款</h3>

<p>本条款仅适用于刘兴明（以下简称我）的蘑菇测量软件产品或服务。</p>

<p>我将蘑菇测量应用程序构建为一个免费的应用程序。此服务由我免费提供按原样使用。</p>

<p>如果有人决定使用我的服务，本页面用于告知访问者我的收集、使用和披露个人信息的政策。</p>

<p>如果您选择使用“我的服务”，则您同意收集和使用与此策略相关的信息。我收集的个人信息用于提供和改进服务。我不会使用或与任何人分享您的信息，除非本隐私政策中有描述。</p>

<p>本隐私政策中使用的术语具有与我们的条款和条件中相同的含义，除非本隐私政策中另有规定，否则可在蘑菇测量访问这些术语。</p>
...
<p>iOS 系统/Android系统权限调用说明</p>
<ul>
<li>存储: 用于存储用户记录、测量文件数据和用户偏好设置等。打开APP同意隐私政策后询问是否授权。</li>
<li>相机: 用于拍照测量目标和参考目标。打开APP同意隐私政策后询问是否授权。</li>
</ul>
...
PCN;
    ...
    function doExecute(\woo\controller\Request $request){
        ...
        switch($type){
            ...
            break;
            case 2: // measure pricacy
                $result = $this->getMeasurePrivacy($language);
        }
    ...
    function getMeasurePrivacy($language){
        $privacys=array(self::$measure_privacy_en,self::$measure_privacy_cn);
        if($language==-1) return $privacys;
        else return $privacys[$language];
    }
}
