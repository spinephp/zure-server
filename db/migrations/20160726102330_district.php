...
class District extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
       // create order packing tray carton table
        ...
        $rows = [
            ...
            ['id'=>441881, 'name'=>'英德市'],
            ['id'=>441882, 'name'=>'连州市'],
            ['id'=>441901, 'name'=>'东莞市市辖区'],
            ['id'=>442001, 'name'=>'中山市市辖区'],
            ['id'=>445101, 'name'=>'市辖区'],
            ['id'=>445102, 'name'=>'湘桥区'],
            ['id'=>445121, 'name'=>'潮安县'],
            ['id'=>445122, 'name'=>'饶平县'],
            ...
            ['id'=>522201, 'name'=>'铜仁市'],
            ['id'=>522222, 'name'=>'江口县'],
            ['id'=>522223, 'name'=>'玉屏侗族自治县'],
            ['id'=>522224, 'name'=>'石阡县'],
            ['id'=>522225, 'name'=>'思南县'],
            ['id'=>522226, 'name'=>'印江土家族苗族自治县'],
            ['id'=>522227, 'name'=>'德江县'],
            ['id'=>522228, 'name'=>'沿河土家族自治县'],
            ['id'=>522229, 'name'=>'松桃苗族自治县'],
            ['id'=>522230, 'name'=>'万山特区'],
            ['id'=>522301, 'name'=>'兴义市'],
            ['id'=>522322, 'name'=>'兴仁县'],
            ['id'=>522323, 'name'=>'普安县'],
            ...
            ['id'=>632123, 'name'=>'乐都县'],
            ['id'=>632126, 'name'=>'互助土族自治县'],
            ['id'=>632127, 'name'=>'化隆回族自治县'],
            ['id'=>632128, 'name'=>'循化撒拉族自治县'],
