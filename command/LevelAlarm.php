	...
	function doExecute(\woo\controller\Request $request){
		...
		*/
		...
		if($mothed == "POST") {
			...
			$levelid = $item["levelalarm"]["levelid"];
			$factory = \woo\mapper\PersistenceFactory::getFactory("levelalarm",array('id','levelid'));
